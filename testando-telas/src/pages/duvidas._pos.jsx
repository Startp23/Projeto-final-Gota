...
import './duvidas._pos.css';
import logoB from '../img/logo_branca.png';
import imagemI from '../img/imagem_inicio.png';
import { Link } from 'react-router-dom';

export default function duvidasPos() {
  return (
    <>
    {/* barra suspensa*/}
    <nav className="navbar-duvidas_pos-pos">
      <div id='start-duvidas_pos-pos' className="menu_item-duvidas_pos-pos">
        <a className="navbar-bran-duvidas_pos-pos" href="/duvidas_pos">
          <img className='imglogo-duvidas_pos-pos' src={logoB} alt="Logo" />
        </a>
      </div>
      <div id='end-duvidas_pos-pos' className='menu_item-duvidas_pos-pos'>
        <ul>
          <Link to='/inipos' className='item-click-duvidas_pos-pos' >Inicio</Link>
            <Link to='/agende' >
              <button
                id='login-menu-duvidas_pos-pos' className='item-click-duvidas_pos-pos' href="#text">Doar</button>
            </Link>
          <Link to='/' className='item-click-duvidas_pos-pos' href="menu.jsx">Sair</Link>
        </ul>
      </div>
    </nav>
    {/*Barra suspensa*/}
    ...
    <main>
      ...
      <div className='topo-site-duvidas_pos-pos'>
        <div id='img-topo-duvidas_pos-pos' className='div-topo-duvidas_pos-pos'>
          <img id='imgsangue-duvidas_pos-pos' src={imagemI} alt="" />
        </div>
        <div id='direita_duvidas_pos-duvidas_pos-pos'>
          <div id='bolinha_desfocada1-duvidas_pos-pos'></div>
          <div className='text-doe-sangue-duvidas_pos-pos'>
            <h1 > Você é a gota que faltava,<br /> doe sangue</h1>
            <p id='text-topo-duvidas_pos-pos' >Doe sangue hoje e faça parte dessa<br />
              corrente de solidariedade que faz<br /> a
              diferença no mundo.</p>
              <div className='btn-doe-duvidas_pos-pos'>
            <Link to='/agende' ><button id='doe-agora-duvidas_pos-pos'>Doe agora</button></Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="informacao-duvidas_pos-pos">
    ...
    <footer>
      <div className='footer-content-duvidas_pos-pos'>

        <div id='lado_direito_footer-duvidas_pos-pos'>
          <div className='rodape-duvidas_pos-pos'>
            <ul>
              <h4>Conteúdo</h4>
              <a href="">Notícias</a>
              <a href="">Dúvidas</a>
          ...
          <div className='rodape-rede-duvidas_pos-pos'>
            <ul>
              <h4>Contatos</h4>
